...
O2 EMR
==================================================
    O2 EMR is an exclusive mini ERP system which helps in the systematic management of a Hospital.
    ...
    O2 EMR is a securely hosted web application for patient care information Management.
